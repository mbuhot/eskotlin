...
class CommonBlock {
    ...
    data class CommonData(
        ...
        fun minimum_should_match(shouldApply: Boolean = true, init: MinimumShouldMatchData.() -> Unit) {
            if (shouldApply) this.minimum_should_match.init()
        }
...
fun common(shouldApply: Boolean = true, init: CommonBlock.() -> CommonBlock.CommonData): CommonTermsQueryBuilder? {
    if (shouldApply) {
